package com.nmc.kotlin.web.basic.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut("within(com.nmc.kotlin.web.basic.repository..*)" +
        " || within(com.nmc.kotlin.web.basic.service..*)" +
        " || within(com.nmc.kotlin.web.basic.web.rest..*)")
